...
int main(int argc, char* argv[])
{
    ...
    string message = "Chiều ngày 7/6, Chủ tịch Quốc hội Vương Đình Huệ đã có cuộc hội đàm trực tuyến với Chủ tịch Hạ Viện Australia Tony Smith nhằm thúc đẩy mối quan hệ Đối tác chiến lược giữa hai quốc gia nói chung và quan hệ nghị viện hai nước nói riêng trong thời gian tới.";
    ...
    /*  kG = (x1, y1), r=x1; 
     s= 𝑘^-1(𝐻(𝑚)+𝑥.𝑟) mod 𝑛 *, h=1, r=s = 2n
     */
    cout << "signature (r,s):" << signature << endl;
    // Coud you compute direct r, s?
